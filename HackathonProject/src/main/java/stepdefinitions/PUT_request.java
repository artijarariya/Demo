...
public class PUT_request {
	...
	/**
	 * Step Definitions for PUT request
	 * 	Variables: 	
	 * 		-	FILEPATH : getting data from given excel file
	 * 		
	 */

	private final String FILEPATH = ConfigFileReader.getProperties("putRequestFilepath");
	...
	public void retrive_data_from_and_for_put(String sheetName, Integer rowNumber)
	...
	public void user_call_base_url_with_endpoint_and_user_id_for_put() {
		...
		/* calling put request and extracting response from it */
